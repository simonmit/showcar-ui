...
/* harmony default export */ __webpack_exports__["a"] = (function (tagName) {
    ...
    var clickHandler = function clickHandler(e) {
        var openTrigger = e.target.closest('[data-lightbox-trigger]');
        var closeTrigger = e.target.closest('[data-lightbox-close]') || !e.target.closest('.sc-lightbox');
    ...
    var show = function show(lightboxTrigger) {
        var dataId = lightboxTrigger.getAttribute('data-id');
        var overlay = document.getElementById(dataId);
        var container = overlay.firstElementChild;
        ...
        setTimeout(function () {
            return overlay.classList.add('sc-fade-in');
        }, 20);
    };
    ...
    var fadeOut = function fadeOut(overlay) {
        overlay.classList.remove('sc-fade-in');
        setTimeout(function () {
            return overlay.classList.add('sc-hidden');
        }, 250);
    };
