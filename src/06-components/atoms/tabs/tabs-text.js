export default () => {
    window.addEventListener('DOMContentLoaded', function () {
        Array.prototype.forEach.call(document.querySelectorAll('[data-tabs-text]'), (tabContainer) => {
            const tabs = tabContainer.querySelectorAll('.sc-tab button');
            Array.prototype.forEach.call(tabs, (tab) => {
                tab.addEventListener('click', (e) => {
                    ...
                    e.target.parentElement.classList.add('sc-tab--with-text--active');
                    ...
                    const sectionAttrNew = e.target.parentElement.getAttribute('data-section');
